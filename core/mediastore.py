"""Снимок медиа в лог-чат.

После удаления сообщения его файл уже не скачать, поэтому медиа копируется в
лог-чат в момент получения. В БД хранится только id сообщения-копии, так что
диск хоста не растёт — файлы лежат в Telegram.
"""
